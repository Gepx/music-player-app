...
class _NowPlayingPageState extends State<NowPlayingPage> {
  ...
  void initState() {
    ...
    final currentTrack = _webPlaybackService.currentTrack;
    ...
    if (currentTrack?.id != widget.track.id) {
      ...
      if (widget.playlist != null && widget.playlist!.isNotEmpty) {
        final currentQueue = _webPlaybackService.queue;
  ...
  SpotifyTrack? get _currentTrack => _webPlaybackService.currentTrack;
                ...
                children: [
                    ...
                    children: [
                      ...
                      Semantics(
                        ...
                        child: IconButton(
                          icon: Icon(
                            Iconsax.previous,
                            color: _webPlaybackService.hasPrevious
                                ? FColors.textWhite
                                : FColors.textWhite.withValues(alpha: 0.3),
                          ),
                          iconSize: 32,
                          onPressed: _webPlaybackService.hasPrevious
                              ? () {
                      ...
                      Semantics(
                        ...
                        child: IconButton(
                          icon: Icon(
                            Iconsax.next,
                            color: _webPlaybackService.hasNext
                                ? FColors.textWhite
                                : FColors.textWhite.withValues(alpha: 0.3),
                          ),
                          iconSize: 32,
                          onPressed: _webPlaybackService.hasNext
                              ? () {
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: Text(
                        'Queue (${_webPlaybackService.queue.length})',
                        style: const TextStyle(
                          fontFamily: 'Poppins',
                          fontWeight: FontWeight.w600,
                        ),
